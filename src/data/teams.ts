 ...
 *
 * 선발 명단은 "정상 컨디션 기준 주전 서열"로 적는다. 부상으로 빠진 선수를 후보로 내리거나
 * 대체 출전 중인 선수를 주전으로 올리지 않으며, 부상·차출 같은 일시적 상태는 이름 필드에도
 * 설명 문장에도 넣지 않는다. 매주 갱신해야 하는 정보를 데이터에 섞지 않기 위한 규칙이다.
 * 이적·감독 교체처럼 되돌아가지 않는 변화만 반영한다.
 */
export const TEAMS: Team[] = [
  ...
  },
  {
      ...
      keyPlayers: [
        {
          ...
          role: "높은 라인의 구조적 축",
          description:
            "압박 각도를 미리 스캔한 뒤 하프스페이스로 예리한 수직 패스를 꽂아, 골키퍼까지 가담해 만든 후방 수적 우위를 곧바로 공격으로 바꾸는 배급형 센터백이다. 유럽 최고 수준으로 높은 수비 라인을 세우는 구조에서 등 뒤 공간을 관리하는 부담도 함께 지며, 오프사이드 트랩의 타이밍을 잡는 기준점 역할을 한다.",
        },
        {
          playerId: "fcb-rodri",
          name: "로드리",
    ...
    players: buildPlayers("4-2-3-1", [
      ...
      { id: "fcb-02", name: "에릭 가르시아 / 쥘 쿤데", number: 24 },
      { id: "fcb-04", name: "파우 쿠바르시", number: 5 },
      { id: "fcb-05", name: "제라르 마르틴 / 안드레아스 크리스텐센", number: 18 },
      { id: "fcb-03", name: "차비 에스파르트 / 주앙 칸셀루", number: 12 },
      { id: "fcb-06", name: "로드리", number: 16 },
      { id: "fcb-08", name: "페드리", number: 8 },
      { id: "fcb-07", name: "라민 야말", number: 10 },
      { id: "fcb-10", name: "페르민 로페스 / 다니 올모", number: 7 },
      ...
      keyPlayers: [
        {
          ...
          role: "빌드업 쿼터백",
          description:
            "센터백 사이로 내려가거나 파블로비치와 자리를 바꿔 백3~4를 만들고, 그 위치에서 템포와 방향 전환을 지휘한다. 케인이 3선까지 처져 상대 센터백을 끌어낸 뒤 열리는 뒷공간으로 보내는 롱패스도 대부분 그의 발끝에서 출발한다.",
        },
        {
  ...
  },
  {
    ...
    tactical: {
      inPossession: {
        summary: "풀백(주로 달로) 한 명이 안쪽으로 좁혀 3백을 형성하고, 더블 피봇이 센터백과 연계해 상대 압박을 끌어낸다.",
        buildUpDescription:
          "쿠냐가 최전방에 설 때는 폴스나인처럼 처지는 움직임으로 래시포드·음뵈모의 침투 공간을 열어주는 유기적 조합 축구가 된다. 반대로 쿠냐가 왼쪽으로 이동하고 셰슈코가 최전방을 맡으면, 셰슈코의 피지컬과 공중볼 경합을 겨냥한 좀 더 직선적인 크로스 전술로 무게중심이 이동하며 쿠냐는 하프스페이스에서 연계하는 역할로 바뀐다.",
        keyPoints: [
          "풀백의 인버트 타이밍",
      ...
      keyPlayers: [
        {
          ...
          role: "더블 피봇(빌드업형)",
          description:
            "틸레만스와 함께 센터백과 짧은 패스를 주고받아 상대 압박을 끌어낸 뒤 중앙 패스 라인을 연다. 여름 최대 영입인 카를로스 발레바가 같은 자리를 노리지만, 발레바가 후방을 덮는 앵커라면 마이누는 전진해 만드는 쪽이라 공존도 가능한 조합으로 평가된다.",
        },
        {
          playerId: "mun-bruno",
          name: "브루누 페르난데스",
        ...
        },
        {
          ...
          name: "마테우스 쿠냐",
          number: 10,
          role: "폴스나인(상황별 타겟맨 전환)",
          description: "쿠냐가 붙박이 최전방으로, 중앙 미드필드까지 자주 내려와 수적 우위를 만드는 폴스나인 역할을 맡는다. 상대가 로우블록으로 내려앉아 공간이 없을 때는 193cm 셰슈코를 최전방에 세우고 쿠냐를 왼쪽으로 옮겨, 크로스를 겨냥한 직선적인 공격으로 색깔을 바꾸는 카드가 준비돼 있다.",
        },
      ],
      tacticalHighlights: [
      ...
      reportSummary:
        "아모림 경질 이후 시스템을 새로 구축하는 단계로, 브루누 페르난데스를 중심에 둔 전개와 £70m를 들인 발레바의 중원 합류가 핵심 변수다.",
    },
    players: buildPlayers("4-2-3-1", [
      { id: "mun-01", name: "센느 라먼스", number: 1 },
      { id: "mun-02", name: "디오구 달로", number: 2 },
      { id: "mun-04", name: "해리 매과이어", number: 5 },
      { id: "mun-05", name: "리산드로 마르티네스", number: 6 },
      { id: "mun-03", name: "루크 쇼 / 파트리크 도르구", number: 23 },
      { id: "mun-06", name: "코비 마이누 / 카를로스 발레바", number: 37 },
  ...
  },
  {
    ...
    tacticalStyle: { lineHeight: 0.75, width: 0.35, wingerTuck: -0.6, fullbackInvert: 0.5, anchorDrop: -0.2, falseNine: 0.3 },
    shortSummary:
    ...
    tactical: {
      inPossession: {
        ...
        buildUpDescription: "킨스키가 센터백 라인까지 올라와 수적 우위를 만들고 판헤케·판더펜이 좌우로 크게 벌리면, 포로와 로버트슨이 동시에 안쪽으로 접혀 중원 라인을 채워 2-4-4 형태가 된다. 여기서 토날리와 시몬스가 하프스페이스로 더 전진해 프런트 파이브를 완성하고, 페르난데스만 중앙에 남아 2-3 레스트 디펜스를 지킨다. 전개의 방아쇠는 센터백의 라인 브레이킹 전진 패스다.",
        keyPoints: [
          "킨스키가 가담해 만드는 후방 수적 우위",
          "양 풀백 동시 인버트 — 2-4-4에서 2-3-5로의 전환",
          "센터백의 라인 브레이킹 전진 패스",
        ],
      },
      outOfPossession: {
      ...
      keyPlayers: [
        {
          ...
          role: "전진형 더블 피봇",
          description:
            "구단 최고 이적료로 합류한 데 제르비의 1순위 영입. 빌드업 초기에는 내려서 후방 전개를 돕다가 팀이 전진하면 우측 하프스페이스로 올라가 프런트 파이브의 일원이 된다. 수비 시에는 상대 최후방 미드필더를 끝까지 따라붙어 압박의 방아쇠를 당기는 역할을 맡는다.",
        },
        {
          ...
          role: "템포를 쥐는 전투형 8번",
          description:
            "좌우 전환 패스로 경기 템포를 설정하고 태클·역압박에 적극적인 체력형 미드필더. 양 풀백이 인버트해 올라간 뒤 중앙에 홀로 남아 2-3 레스트 디펜스를 지키는, 구조상 가장 대체하기 어려운 자원이다.",
        },
        {
          playerId: "tot-vandeven",
          name: "미키 판더펜",
          number: 37,
          role: "하이라인 스위퍼 주장",
          description:
            "재계약과 함께 주장으로 선임된 팀의 기준점. 킨스키를 빌드업에 끌어올리고 수비 라인을 높이 세우는 구조에서, 등 뒤로 넘어온 공을 순수 스피드로 회수해 시스템 자체를 성립시킨다. 세트피스에서는 헤더 위협도 제공한다.",
        },
      ],
      tacticalHighlights: [
        "킨스키의 빌드업 가담과 하이라인 뒷공간 커버",
        "포로·로버트슨이 동시에 안으로 접히는 타이밍",
        "볼은 윙어까지 가지만 박스 안 움직임이 단순해 마무리되지 않는 문제",
      ],
      reportSummary:
        "£250m 이상을 쓴 대규모 스쿼드 개편 이후 빌드업 구조는 자리를 잡았지만, 마지막 3분의 1에서의 해법과 전방 압박의 완성도가 아직 따라오지 못한 과도기다.",
    },
    players: buildPlayers("4-2-3-1", [
      { id: "tot-01", name: "안토닌 킨스키", number: 31 },
      { id: "tot-02", name: "페드로 포로", number: 23 },
      { id: "tot-04", name: "얀 폴 판헤케", number: 6 },
      { id: "tot-05", name: "미키 판더펜", number: 37 },
      { id: "tot-03", name: "앤디 로버트슨 / 데스티니 우도기", number: 3 },
      { id: "tot-06", name: "산드로 토날리", number: 16 },
      { id: "tot-08", name: "마테우스 페르난데스 / 로드리고 벤탄쿠르", number: 18 },
  ...
  },
  {
    ...
    tactical: {
      inPossession: {
        summary: "조르제 제수스식 포지션 플레이를 기반으로 자카리아-카마라 더블 피봇이 짧은 패스로 볼을 순환시키고, 좁고 유기적인 공격 구조 속에서 골로빈·이덤보가 위치를 바꿔가며 수직적으로 전진한다.",
        buildUpDescription: "반데르송과 나지뉴가 폭을 전담하는 동안 골로빈·이덤보·쿨리발리는 좁게 서서 브루너 주변에서 위치를 교환하며 하프스페이스를 두텁게 채운다.",
        keyPoints: [
          "더블 피봇 중심의 중앙 빌드업",
          "이덤보의 좌우 겸용 창조 역할",
          "브루너의 돌파형 침투",
      ...
      reportSummary: "감독 교체 직후 5연승으로 순항 중인 팀으로, 브루너의 브레이크아웃과 자카리아-카마라 더블 피봇의 안정감이 핵심이다. 아클리우슈는 여름 이적시장에서 PSG로 떠났고 포그바는 구단과 계약을 해지해 팀을 떠났다.",
    },
    players: buildPlayers("4-2-3-1", [
      { id: "mco-01", name: "루카시 흐라데츠키", number: 1 },
      { id: "mco-02", name: "반데르송", number: 2 },
      { id: "mco-04", name: "사디부 사네", number: 72 },
      { id: "mco-05", name: "에릭 다이어", number: 15 },
      { id: "mco-03", name: "플라비우 나지뉴", number: 20 },
      { id: "mco-06", name: "라민 카마라", number: 8 },
      { id: "mco-08", name: "데니스 자카리아", number: 6 },
    ...
    tactical: {
      ...
      keyPlayers: [
        ...
        },
        {
          ...
          role: "고립형 윙어",
          description:
            "오른쪽 터치라인에 붙어 폭을 유지하며 상대 풀백과의 1대1 고립 상황을 의도적으로 만들어내는 공격의 결정 포인트다. 압박 경로를 미리 설계해 상대를 측면으로 몰아넣는 구조에서, 공을 되찾은 직후 가장 먼저 받아 전진시키는 출구이기도 하다.",
        },
      ],
      tacticalHighlights: [
        "칼라피오리의 인버트 타이밍",
      ...
      reportSummary: "정교하게 설계된 세트피스와 3-2-4-1 빌드업 구조로 우위를 만드는 팀이며, 마르티넬리·제주스·트로사르가 한꺼번에 떠난 자리를 £34m 영입 촐리스가 왼쪽 윙에서 곧바로 메우고 있다. 여름에는 £51m 콘사와 £75m 기마랑이스까지 더해 수비·중원 뎁스를 두껍게 보강했다.",
    },
    players: buildPlayers("4-3-3", [
      { id: "ars-01", name: "다비드 라야", number: 1 },
      { id: "ars-02", name: "위리엔 팀버르 / 벤 화이트", number: 12 },
      { id: "ars-04", name: "윌리엄 살리바 / 에즈리 콘사", number: 2 },
  ...
  },
  {
      ...
      keyPlayers: [
        {
          ...
          role: "단일 피봇",
          description:
            "빌드업 시 센터백 사이로 내려가 임시 3백을 만들어, 라움과 바쿠 두 풀백을 극단적으로 높고 넓게 전진시키는 기점이다. 경기 중에도 대형이 수차례 바뀌는 유동적인 구조에서 위치가 흐트러졌을 때 중앙을 다시 잡아주는 기준점 역할을 한다.",
        },
        {
          playerId: "rbl-nusa",
          name: "안토니오 누사",
        ...
        },
        {
          ...
          role: "유동적 스트라이커",
          description:
            "최전방에 고정되는 타겟맨이 아니라 10번 공간과 측면을 오가며 미드필더들과 자리를 계속 바꾸는 유형이다. 전방 자원이 안쪽으로 좁혀 중앙과 하프스페이스를 과부하시키는 구조의 중심에서, 좁은 지역 콤비네이션으로 박스에 진입하는 역할을 맡는다.",
        },
      ],
      tacticalHighlights: [
    ...
    players: buildPlayers("4-3-3", [
      ...
      { id: "rbl-04", name: "빌리 오르반", number: 4 },
      { id: "rbl-05", name: "카스텔로 뤼케바 / 막심 에스테브", number: 23 },
      { id: "rbl-03", name: "다비트 라움", number: 22 },
      { id: "rbl-06", name: "니콜라스 자이발트", number: 13 },
      { id: "rbl-08", name: "아산 웨드라오고 / 에제키엘 반주지", number: 8 },
      { id: "rbl-10", name: "닐 엘 아이나위 / 로코 라이츠", number: 21 },
    ...
    tactical: {
      ...
      keyPlayers: [
        ...
        },
        {
          ...
          number: 10,
          role: "폴스나인",
          description: "고정된 최전방이 아닌 폴스나인으로 처져 수비를 끌어내고, 동시에 팀 압박의 첫 번째 트리거를 담당한다.",
        },
        {
          playerId: "psg-hakimi",
          name: "아슈라프 하키미",
  ...
  },
  {
    ...
    tactical: {
      inPossession: {
        summary: "호이비에르가 센터백 사이로 내려앉아 후방 3인 구조를 만들고, 그 위에서 압델리가 한 칸 전진해 상대 1차 압박선 뒤에서 볼을 받는 더블 피봇 구조다.",
        buildUpDescription: "고메스가 10번 자리에서 라인 사이를 오가며 전진 패스의 목적지가 되고, 측면은 비대칭으로 쓴다. 웨아가 오른쪽에서 높이 올라가 하릿을 안쪽으로 밀어 넣는 동안, 왼쪽은 파이샹이 폭을 유지한 채 에메르송이 언더랩한다. 마무리는 구이리를 향한 컷백과 하프스페이스 침투 패스가 주된 루트다.",
        keyPoints: [
          "호이비에르의 드롭으로 만드는 후방 3인",
          "웨아의 오버래핑과 하릿의 인사이드 전환",
          "구이리를 향한 컷백과 하프스페이스 침투",
        ],
      },
      outOfPossession: {
      ...
      keyPlayers: [
        {
          ...
          role: "침투형 스트라이커",
          description:
            "원톱이지만 박스 안에만 머무르지 않고 하프스페이스로 내려와 등지고 받으며 중원 수 싸움을 도와준다. 그렇게 만들어진 공간으로 파이샹과 하릿이 안쪽 침투를 하고, 본인은 다시 크로스 낙하 지점으로 복귀해 마무리한다. 팀 내 득점 1위로 공격 생산량이 그에게 집중돼 있다.",
        },
        {
        ...
        },
        {
          ...
          role: "주장·오버래핑 라이트백",
          description:
            "본래 윙어였으나 스쿼드 재편 이후 오른쪽 풀백 겸 주장으로 역할이 바뀌었다. 윙어 출신다운 스프린트와 볼 운반으로 높이 올라가 하릿과 겹치며 상대 풀백을 2대1로 공략한다. 다만 수비 국면의 위치 선정은 정통 풀백보다 거칠어 실점 장면의 빌미가 되기도 한다.",
        },
      ],
      tacticalHighlights: [
        "구이리의 처짐과 재침투",
    ...
    players: buildPlayers("4-2-3-1", [
      { id: "mar-01", name: "제프리 더랭", number: 12 },
      { id: "mar-02", name: "티모시 웨아", number: 22 },
  ...
  },
  {
    ...
    players: buildPlayers("4-3-3", [
      ...
      { id: "laf-02", name: "라이언 홀링스헤드 / 세르지 팔렌시아", number: 24 },
      { id: "laf-04", name: "라이언 포티어스", number: 5 },
      { id: "laf-05", name: "애런 롱 / 은코시 타파리", number: 33 },
      { id: "laf-03", name: "예브헨 체베르코 / 케니 닐슨", number: 23 },
      { id: "laf-06", name: "에디 세구라", number: 4 },
      { id: "laf-08", name: "마티외 슈아니에르", number: 66 },
      { id: "laf-10", name: "마르코 델가도 / 주드 테리", number: 8 },
      { id: "laf-07", name: "타일러 보이드 / 제이콥 샤펠버그", number: 19 },
    ...
    tactical: {
      ...
      keyPlayers: [
        ...
        },
        {
          ...
          role: "좌측 8번·공격의 기준점",
          description:
            "왼쪽 하프스페이스에서 피봇과 좌측 윙어를 잇다가 라인 사이로 전진해 최종 3분의 1에서 직접 마무리까지 가져간다. 리그 최다 득점자이자 8월 이달의 선수로, 공격 전개가 그의 위치 선정에서 시작된다.",
        },
        {
          playerId: "por-hwang",
          name: "황인범",
          ...
          role: "로우블록 브레이커",
          description:
            "로우블록을 상대로 템포를 조절하는 데 특화된 볼 배급형 미드필더로, 파리올리 감독이 여러 팀을 거치며 거듭 영입을 시도했던 프로필이다. 중원 경쟁이 두터워 선발보다는 흐름을 바꾸는 교체 카드로 쓰이며, 벤피카와의 클라시쿠에서 교체 투입 후 쐐기골을 넣었다.",
        },
      ],
      tacticalHighlights: [
      ...
      reportSummary: "데 제르비 사단의 후방 빌드업 구조(풀백 인버트, 피봇의 백라인 합류)를 기반으로 하되, 전방 연결이 막히면 최전방을 겨냥한 롱볼로 우회하는 실리적인 팀이다. 리그 최소 실점급 수비 조직력이 승점의 실질적 원동력이며, 로테이션 자원인 황인범이 등판할 경우 로우블록 공략력이 보완된다.",
    },
    players: buildPlayers("4-3-3", [
      ...
      { id: "por-03", name: "자이두 사누시 / 프란시스쿠 모라", number: 12 },
      { id: "por-06", name: "파블로 로사리오", number: 13 },
      { id: "por-08", name: "빅토르 프로홀트 / 황인범", number: 8 },
      { id: "por-10", name: "가브리 베이가", number: 10 },
      { id: "por-07", name: "윌리엄 고메스", number: 7 },
      { id: "por-11", name: "페페", number: 11 },
      { id: "por-09", name: "사무 아게호와 / 안드레 실바", number: 9 },
  ...
  // ───────────────────────── 3-4-2-1 ─────────────────────────
  {
    ...
    players: buildPlayers("3-4-2-1", [
      ...
      { id: "rom-07", name: "웨슬리 / 데빈 렌스", number: 43 },
    ...
    tactical: {
      ...
      keyPlayers: [
        ...
        },
        {
          ...
          number: 7,
          role: "오른쪽 윙백",
          description: "3-2-5 구조 완성의 핵심으로, 공격 시 최종지역까지 전진해 폭과 오버로드를 동시에 제공한다. 아탈란타에서 영입된 마르코 팔레스트라가 같은 자리를 노리는 경쟁자다.",
        },
      ],
      tacticalHighlights: [
        "백3-3-2-5 가변 구조 전환",
  ...
  },
  {
    ...
    tactical: {
      inPossession: {
        summary: "로카텔리가 두 센터백 사이로 내려앉아 임시 백3를 만들고, 그 앞을 더글라스 루이스가 홀로 지키는 3-3 구조로 상대 압박에 맞선다.",
        buildUpDescription: "내려앉은 로카텔리 위에서 양 풀백이 폭을 벌려, 압박해 오는 선수마다 두 개 이상의 전진 선택지를 만들어 수적 균형을 맞춘다. 전진 단계에서는 이을드즈가 왼쪽 하프스페이스로 좁혀 들어오고 콘세이상이 오른쪽 터치라인에 붙어 1대1을 강요하며, 맥케니가 라인 사이로 침투해 마지막 연결을 만든다.",
        keyPoints: [
          "로카텔리의 드롭으로 만드는 임시 백3",
          "이을드즈의 좌측 하프스페이스 침투",
          "콘세이상의 우측 1대1 고립",
        ],
      },
      outOfPossession: {
        summary: "수비 시 4-4-2로 전환해 물러서지 않고 매우 높은 라인을 유지하며, 상대가 등을 돌려 리셋하는 순간 곧바로 전진해 공간을 압축한다.",
        defensiveShapeDescription: "콜로 무아니와 공격형 미드필더가 2선 압박 라인을 이뤄 센터백과 피봇의 연결을 끊고, 측면 자원은 상대 풀백에게 패스가 나가는 순간 안쪽을 닫아 터치라인으로 몰아넣는다.",
        pressingDescription: "백패스를 트리거로 즉각 협공하고 탈취 직후 빠른 역습으로 전환한다. 다만 상대가 중앙과 측면을 오가며 블록을 흔들면 라인 간격이 벌어지는 약점이 반복된다.",
        keyPoints: [
          "물러서지 않는 높은 라인과 오프사이드 트랩",
          "수비 시 4-4-2 전환과 측면 유도",
          "블록이 흔들릴 때 벌어지는 라인 간격",
        ],
      },
      keyPlayers: [
        {
        ...
        },
        {
          ...
          role: "백4의 수비 앵커",
          description:
            "루쿠미와 짝을 이뤄 높은 라인을 유지하며 뒷공간 커버와 대인 방어를 동시에 처리하고, 상대가 등을 돌리는 순간 라인을 끌어올리는 트리거를 잡는다. 세트피스 공격에서는 직접 득점을 만들어내는 실질적인 공격 옵션이기도 하다.",
        },
        {
          playerId: "juv-conceicao",
          name: "프란시스쿠 콘세이상",
          number: 7,
          role: "우측 아이솔레이션 드리블러",
          description:
            "오른쪽 터치라인에 붙어 1대1을 고정적으로 요구하고, 오버랩해 올라오는 첼릭과 묶여 측면 과부하를 만든다. 돌파 이후에는 컷백과 얼리 크로스로 콜로 무아니에게 공급하는, 개막 이후 가장 꾸준한 공격 포인트 생산자다.",
        },
      ],
      tacticalHighlights: [
        "로카텔리가 내려앉아 만드는 임시 백3",
        "물러서지 않는 높은 라인과 오프사이드 트랩",
        "콘세이상-첼릭의 우측 과부하",
      ],
      reportSummary: "백4로 돌아선 뒤에도 공격적인 라인 운용을 고수하는 팀으로, 이을드즈의 개인기와 로카텔리발 후방 전개를 함께 활용한다.",
    },
    players: buildPlayers("4-2-3-1", [
      { id: "juv-01", name: "굴리엘모 비카리오", number: 25 },
      { id: "juv-02", name: "제키 첼릭", number: 2 },
      { id: "juv-04", name: "욘 루쿠미 / 로이드 켈리", number: 26 },
      { id: "juv-05", name: "브레메르", number: 3 },
      { id: "juv-03", name: "피에르 칼룰루 / 안드레아 캄비아소", number: 15 },
      { id: "juv-06", name: "마누엘 로카텔리 / 케프렌 튀랑", number: 5 },
      { id: "juv-08", name: "더글라스 루이스", number: 12 },
      { id: "juv-07", name: "프란시스쿠 콘세이상", number: 7 },
  ...
  },
  {
    ...
    players: buildPlayers("3-4-2-1", [
      ...
      { id: "bvb-can", name: "조안 가두 / 엠레 잔", number: 22 },
      ...
      { id: "bvb-09", name: "세루 기라시 / 파비우 실바", number: 9 },
  ...
  },
  {
    ...
    tactical: {
      ...
      keyPlayers: [
        ...
        {
          playerId: "s04-elfaouzi",
          name: "수피안 엘파우지",
          number: 23,
          role: "중원의 볼 배급 엔진",
          description: "스쿼드 최고 시장가치 자원이자 공식전 전 경기 선발 중앙 미드필더로, 백3와 전방을 잇는 연결 고리다. 오른쪽 중앙에서 다나카와 짝을 이뤄 볼을 받아 방향을 전환하고, 수비 전환 시에는 첫 번째 저지선을 만들어 역습을 늦춘다.",
        },
        {
          playerId: "s04-hwang",
          name: "황희찬",
          number: 7,
          role: "만능형 전방 자원",
          description: "마감일 임대로 합류한 만능형 공격 자원으로, 측면과 최전방을 모두 소화하며 전방 압박 가담량이 많다. 합류 직후 두 경기 모두 교체로 나서 도움을 기록했고, 실질적인 경쟁 지점은 왼쪽이 아니라 최전방 1톱이다.",
        },
      ],
      tacticalHighlights: [
        "1부 승격 후 첫 시즌 적응 과정",
    ...
    players: buildPlayers("3-4-2-1", [
      ...
      { id: "s04-03", name: "티모 베커", number: 5 },
      { id: "s04-04", name: "니콜라 카티치", number: 25 },
      { id: "s04-05", name: "하산 쿠루차이", number: 4 },
      { id: "s04-10", name: "주니오르 디나 에빔베 / 데얀 류비치치", number: 29 },
      { id: "s04-02", name: "수피안 엘파우지", number: 23 },
      { id: "s04-06", name: "다나카 사토시 / 론 샬렌베르크", number: 13 },
      { id: "s04-12", name: "로빈 고젠스 / 비탈리 베커", number: 8 },
    ...
    tactical: {
      ...
      keyPlayers: [
        ...
        },
        {
          ...
          role: "박스크래셔",
          description:
            "깊은 위치에서 출발해 공격이 전개된 뒤 한 박자 늦게 박스로 뛰어드는, 시메오네 축구의 상징적인 자원이다. 수비 시에는 로우블록의 측면 미드필더로 내려와 풀백을 보호하고, 공을 되찾은 직후에는 그대로 전진해 역습의 두 번째 파도를 만든다.",
        },
      ],
      tacticalHighlights: [
        "알바레스의 연계 이탈 움직임",
    ...
    tactical: {
      ...
      keyPlayers: [
        ...
        },
        {
          ...
          role: "투톱 리더·주장",
          description:
            "투톱의 앞선에서 득점을 책임지는 동시에 전방 압박의 첫 스위치를 켜는 주장이다. 최종지역에서 3-2-5로 변형된 뒤 양 측면에서 쏟아지는 크로스의 주된 마무리 지점이며, 짧게 내려와 투톱 파트너의 침투 공간을 열어주는 연계도 함께 담당한다.",
        },
        {
          ...
          role: "딥라잉 플레이메이커",
          description:
            "빌드업 시 센터백 사이나 옆으로 내려가 임시 백4를 만들며 팀의 템포를 조율한다. 그가 내려가 만든 여유가 양 윙백을 백5 높이까지 밀어올리는 동력이 되고, 여기서 뿌리는 대각 전환 패스가 인테르 크로스 공세의 출발점이 된다.",
        },
      ],
      tacticalHighlights: [
      ...
      keyPlayers: [
        {
          ...
          role: "와이드 로밍 포워드",
          description:
            "중앙에 고정되지 않고 측면과 하프스페이스로 넓게 움직여, 중원을 건너뛰고 날아온 롱볼을 지켜주는 것이 1차 임무다. 그렇게 버는 시간으로 팀 전체가 전진할 발판을 만들고, 투톱 파트너가 박스 안으로 들어갈 공간을 열어준다.",
        },
        {
          playerId: "get-unal",
          name: "에네스 위날",
          ...
          role: "타겟맨",
          description:
            "2026년 8월 복귀한, 박스 안에서 크로스와 세컨볼 마무리를 전담하는 전형적인 타겟맨이다. 사트리아노가 측면으로 빠져 볼을 지켜주는 동안 중앙 마무리 지점을 지키며, 라리가에서 가장 직선적인 이 팀의 공격을 득점으로 바꾸는 종착점 역할을 한다.",
        },
        {
          playerId: "get-djene",
          name: "제네",
          ...
          role: "수비 리더·주장",
          description:
            "리그 최고 수준의 볼경합·압박 수치를 상징하는 팀의 수비 리더이자 주장이다. 백5의 중심에서 몸싸움 기반 대인 압박의 기준점을 잡아주고, 상대 최전방을 직접 따라붙어 리듬을 끊는 것이 그의 역할이다.",
        },
      ],
      tacticalHighlights: [
        "두 스트라이커의 '연계-침투' 로테이션",
  ...
  // ───────────────────────── 4-3-1-2 ─────────────────────────
  {
    ...
    tactical: {
      ...
      keyPlayers: [
        ...
        },
        {
          ...
          role: "침투형 투톱",
          description:
            "조규성이 볼을 지켜주는 동안 상대 백라인의 뒷공간과 채널로 뛰어드는 팀 내 최다 득점원이다. 공을 끊어낸 직후 곧바로 전환하는 구조에서 가장 먼저 상대 골문을 향해 달려나가는 종착점이며, 컷백 연계로 동료의 득점도 만들어낸다.",
        },
        {
          ...
          role: "박스투박스 미드필더",
          description:
            "피지컬을 앞세워 중원에 무게감을 더하고, 경기가 늘어진 후반에는 박스까지 직접 뛰어들어 마무리에 가담한다. 유닛 단위로 강하게 압박해 높은 지역에서 공을 끊어내는 구조에서 몸싸움의 중심이 되는 자원이다.",
        },
      ],
      tacticalHighlights: [
        "조규성-에팀의 투톱 롤 분담(홀드업 vs 침투)",
    ...
    players: buildPlayers("4-3-1-2", [
      { id: "fcm-01", name: "엘리아스 라픈 올라프손", number: 1 },
      { id: "fcm-02", name: "라스무스 크리스텐센", number: 5 },
      { id: "fcm-04", name: "마르틴 에를리치", number: 6 },
      { id: "fcm-05", name: "마그누스 옌센", number: 3 },
      { id: "fcm-03", name: "빅토르 바크 / 베니 주니오르", number: 55 },
  ...
  },
  {
      ...
      keyPlayers: [
        {
          ...
          number: 7,
          role: "하프스페이스 커넥터",
          description: "3-5-2의 오른쪽 인사이드 미드필더로, 상대 3선과 4선 사이에서 공을 받아 전진 패스와 레이오프로 공격을 시작한다. 볼이 없을 때는 상대 수비형 미드필더의 패스 각도를 차단해 전방 압박의 시작을 맡는다. 피셔 체제의 전술 규율에 가장 잘 맞는 자원으로 공식전 전 경기 선발이다.",
        },
        {
          playerId: "m05-amiri",
          name: "나딤 아미리",
          number: 10,
          role: "좌측 인사이드 플레이메이커",
          description: "이전 체제에서는 수비 가담 부담이 커 활동 범위가 제한적이었지만, 피셔의 3-5-2에서는 수비 임무를 상당 부분 덜어내고 공격 전개에만 집중할 수 있게 되며 '해방'됐다는 평가를 받는다. 왼쪽 하프스페이스에서 투톱에게 연결하는 마지막 패스를 담당한다.",
        },
        {
          playerId: "m05-becker",
          name: "셰랄도 베커르",
          number: 23,
          role: "침투형 세컨드 스트라이커",
          description: "티츠와 짝을 이루는 투톱의 움직이는 축으로, 뒷공간 침투와 측면으로 빠져 수비를 끌어내는 역할을 동시에 수행한다. 팀 내 도움 1위이며 크로스와 세트피스 상황의 박스 안 결정력이 특히 두드러진다.",
        },
      ],
      tacticalHighlights: [
        "아미리의 하프스페이스 연결 플레이",
    ...
    players: buildPlayers("3-5-2", [
      ...
      { id: "m05-gruber", name: "파비오 그루버", number: 3 },
      { id: "m05-potulski", name: "카츠페르 포툴스키 / 도미니크 코어", number: 48 },
      { id: "m05-widmer", name: "앙토니 카시 / 질반 비드머", number: 19 },
      { id: "m05-07", name: "이재성", number: 7 },
      { id: "m05-06", name: "사노 카이슈", number: 6 },
      { id: "m05-10", name: "나딤 아미리 / 파울 네벨", number: 10 },
    ...
    tactical: {
      ...
      keyPlayers: [
        ...
        },
        {
          ...
          role: "더블 피봇 앵커",
          description:
            "오랜 기간 팀을 지탱해온 더블 피봇의 앵커로, 바우어와 함께 백4 앞을 스크린하며 후방에서 템포를 조율한다. 중앙을 잠근 뒤 전방 4인에게 빠르게 볼을 연결해 공격 전환의 속도를 결정하는 것이 핵심 임무다.",
        },
        {
          playerId: "cel-duran",
          name: "카밀로 두란",
