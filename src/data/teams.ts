    ...
    tactical: {
      ...
      keyPlayers: [
        ...
        },
        {
          ...
          role: "침투형 투톱",
          description:
            "조규성이 볼을 지켜주는 동안 상대 백라인의 뒷공간과 채널로 뛰어드는 팀 내 최다 득점원이다. 높은 지역에서 공을 끊어낸 직후 곧바로 전환하는 구조에서, 가장 먼저 상대 골문을 향해 달려나가는 종착점 역할을 맡는다.",
        },
        {
      ...
      keyPlayers: [
        {
          ...
          number: 7,
          role: "커넥터형 미드필더",
          description: "중앙에서 자유롭게 침투하며 라인 사이를 잇는 미드필더로, 후방에서부터 박스로 뛰어드는 타이밍이 좋아 헤더 득점까지 만들어낸다. 같은 자리를 놓고 아미리와 번갈아 기용된다.",
        },
        {
          playerId: "m05-amiri",
          name: "나디엠 아미리",
