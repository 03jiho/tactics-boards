      ...
      keyPlayers: [
        {
          ...
          number: 8,
          role: "박스투박스 미드필더",
          description: "콘테 시절보다 깊어진 역할이지만 여전히 박스 침투 능력을 보유했다.",
        },
        {
          ...
          number: 11,
          role: "로테이션 플레이메이커",
          description: "하프스페이스에서 반 박자 늦게 볼을 받아 라인을 끊는 패스를 공급하는 팀 내 개인 기량의 정점이지만, 수비 가담량 문제로 붙박이 주전보다는 경기 성격에 따라 투입되는 로테이션 자원에 가깝다.",
        },
        {
      ...
      keyPlayers: [
        {
          ...
          number: 19,
          role: "폴스나인",
          description: "최전방에서 아래로 처져 상대 센터백을 끌어내고, 그렇게 열린 공간으로 시메오네와 측면 자원이 뛰어드는 길을 만드는 공격 전개의 기점이다.",
        },
        {
