  ...
  },
  {
    ...
    tactical: {
      inPossession: {
        ...
        buildUpDescription: "위아가 오른쪽 풀백에서 안쪽으로 좁혀 들어가 빌드업 인원을 늘리고, 스루패스보다 제3자 콤비네이션으로 상대 압박 라인을 끊어 구이리의 침투로를 여는 것이 릴 시절부터 이어진 원칙이다. 원래 미드필더인 콩도그비아를 센터백으로 기용해 빌드업 능력을 더하는 실험도 병행한다.",
        keyPoints: [
          "위아의 풀백 전환",
          "압델리의 후방 진행",
          "구이리를 향한 직선적 종패스",
      ...
      keyPlayers: [
        {
          ...
          role: "침투형 스트라이커",
          description:
            "재편된 공격진의 핵심 득점원으로, 발밑에서 받기보다 상대 백라인 등 뒤 공간을 노리는 침투 움직임이 특징이다. 위아와 압델리가 제3자 콤비네이션으로 상대 압박 라인을 끊어주는 순간 열리는 채널로 뛰어드는 것이 팀의 주요 공격 루트다.",
        },
        {
        ...
        },
        {
          ...
          role: "주장·오른쪽 풀백",
          description:
            "본래 윙어였으나 스쿼드 재편 이후 오른쪽 풀백 겸 주장으로 역할이 바뀌었다. 터치라인을 오르내리는 대신 안쪽으로 좁혀 들어가 빌드업 인원을 늘리고, 제3자 콤비네이션의 한 축으로 구이리의 침투로를 여는 것이 주된 임무다.",
        },
      ],
      tacticalHighlights: [
        "구이리의 등 뒤 공간 침투",
    ...
    tactical: {
      ...
      keyPlayers: [
        ...
        },
        {
          ...
          role: "이중 옵션 윙어",
          description:
            "터치라인에 붙어 폭을 제공하다가 안쪽으로 좁혀 박스로 진입하는 두 가지 선택지를 동시에 쥐는 윙어다. 3선에서 2선으로 이어지는 연결이 끊겨 롱볼로 우회하는 경기에서는 세컨볼을 주워 곧바로 전진시키는 탈출구 역할도 맡는다.",
        },
        {
          playerId: "por-hwang",
          name: "황인범",
